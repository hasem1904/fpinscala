...
object IO0 {
  ...
  /**
    ...
    * (it is only a monoid), and not many laws to help with reasoning.
    * It is completely _opaque_. Also cannot represent _input_ effects, like
...
object IO3 {
  ...
  /** Exercise 13.2
    * Implement a specialized `Function0` interpreter.
    * */
  @annotation.tailrec
  ...
  */
  ...
  /**
    * Exercise 13.4
    * Implement a `Free` interpreter which works for any `Monad`
    * Implement `runConsole` using `runFree`,
  ...
  */
  ...
  /**
    * Exercise 13.5:
    * Implement a non-blocking read from an asynchronous file channel.
...
/**
  * Testing the ConverterApp
  * Xtra: https://github.com/akkomar/fp-scala/blob/master/answers/src/main/scala/fpinscala/iomonad/IO.scala
  */
...
object StackOverFlowApp extends App {
  ...
  val p = IO.forever(IO1.PrintLine("Still going..."))
  //Testing the IO Monad => StackOverflowError
  p.run
}

object RunFreeMonadApp extends App {
